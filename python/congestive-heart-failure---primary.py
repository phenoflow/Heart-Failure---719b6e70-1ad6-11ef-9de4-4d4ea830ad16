...
codes = [{"code":"G580.00","system":"readv2"},{"code":"G580100","system":"readv2"},{"code":"G580.11","system":"readv2"},{"code":"4270C","system":"readv2"},{"code":"402 C","system":"readv2"},{"code":"4270","system":"readv2"}];
REQUIRED_CODES = 1;
